...
class ActivityList extends StatelessWidget {
 ...
 final Function toggleActivity;
  ...
  const ActivityList({ this.activities, this.toggleActivity}) ;
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 2.0, crossAxisSpacing: 5.0),
